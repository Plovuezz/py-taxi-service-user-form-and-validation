...
from taxi.views import (
    ...
    DriverListView, DriverDetailView, DriverCreateView,
    DriverUpdateView, DriverLicenseUpdate, DriverDeleteView,
    assign_to_car, delete_from_car,
)
...
urlpatterns = [
    ...
    path(
        "cars/<int:pk>/from_delete/",
        delete_from_car,
        name="from-car-delete"
    ),
]
